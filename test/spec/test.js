  ...
  describe('Tests certificate parser', function () {
    ...
    describe('opening certificate details page', function () {
      it('should have the correct fields', function () {
        ...
        detailsListItems = document.querySelector('#content ul li');

        expect(detailsListItems[0]).toBe('Common name: DST Root CA X3');
        expect(detailsListItems[1]).toBe('Organization: Digital Signature Trust Co.');
        expect(detailsListItems[2]).toBe('Issuer: DST Root CA X3, Digital Signature Trust Co.');
        expect(detailsListItems[3]).toBe('Serial Number: 44afb080d6a327ba893039862ef8406b');
        expect(detailsListItems[4]).toBe('Valid From: 30 September 2000 [2000-09-30T21:12:19.000Z]');
        expect(detailsListItems[5]).toBe('Valid To: 30 September 2021 [2021-09-30T14:01:15.000Z]');
        expect(detailsListItems[6]).toBe('SHA1: DAC9024F54D8F6DF94935FB1732638CA6AD77C13');
        expect(detailsListItems[7]).toBe('SHA256: 0687260331A72403D909F105E69BCF0D32E1BD2493FFC6D9206D11BCD6770739');
